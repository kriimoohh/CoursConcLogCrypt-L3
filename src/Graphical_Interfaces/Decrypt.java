...
import cryptosymetrique.Dechiffrement;
...
public class Decrypt extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        File_Path.setText("File to Decrypt");
    ...
    Path = Path+"//Decrypted.txt";
    
    Dechiffrement Decrypt = new Dechiffrement();
    Decrypt.runCipher(Key_Path.getText(), File_Path.getText(), Path);
